...
const PLForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const url = `${process.env.REACT_APP_BASE_URL}/auth/PL`; // Ensure this URL is correct
  ...
  const sendPLMessageToParents = async (formData) => {
    ...
    try {
      const response = await fetch(`${process.env.REACT_APP_BASE_URL}/message/sendPLMessageToParents`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const sendPLMessageToTeachers = async (formData) => {
    ...
    try {
      const response = await fetch(`${process.env.REACT_APP_BASE_URL}/message/sendPLMessageToTeachers`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
